...
export function SopDetail({
  ...
  const [category, setCategory] = useState<SopCategory>(sop.category as SopCategory)
  ...
  const autoSuggestedSigRef = useRef<string>(`${sop.title}|${sop.content}`)
  ...
  return (
    <div>
      ...
      <div className="bg-gray-900 rounded-xl border border-gray-800 p-6 max-w-3xl">
        <SopContent content={currentSop.content} />
      </div>
    </div>
  )
}
