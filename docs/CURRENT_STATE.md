...
- **Content v2 next**: Phase 3 (campaign CRUD: list/detail/create + milestones + CR event picker) — wait for Geneva/Maddie's reaction at the meeting first. Spec § "Recommended implementation phasing".
