...
- **Content v2 next**: Phase 4 (planning form + fan-out; needs the content_calendar extension migration) — pending Geneva/Maddie's reaction at the 7/2 meeting. Spec § "Recommended implementation phasing".
